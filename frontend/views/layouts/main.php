        ...
        <div class="container">
            ...
            <div ng-class="!navCollapsed && 'in'" ng-click="navCollapsed=true" class="collapse navbar-collapse" >
                <ul class="navbar-nav navbar-right nav">
                    <li data-match-route="/$" ng-hide="loggedIn()">
                        <a href="#/">Home</a>
                    </li>
                    <li data-match-route="/about" ng-hide="loggedIn()">
                        <a href="#/about">About</a>
                    </li>
                    <li data-match-route="/contact">
                        <a href="#/contact" ng-hide="loggedIn()">Contact</a>
                    </li>
                    <li data-match-route="/jobs">
                        <a href="#/jobs">Jobs</a>
                    </li>
                    ...
                    <li data-match-route="/register" ng-hide="loggedIn()">
